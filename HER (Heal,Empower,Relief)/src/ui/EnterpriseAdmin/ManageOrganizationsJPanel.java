...
public class ManageOrganizationsJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo(){
        ...
        if(enterprise.getEnterpriseType().getValue().equalsIgnoreCase("ASIT")){
            for (Organization.Type type : Organization.Type.values()){
                if (type.getValue().equals(Organization.Type.CaseSupervisingOrganization.getValue()) || type.getValue().equals(Organization.Type.CounsellingOrganization.getValue())){
                    comboBoxOrgType.addItem(type);
                }
            }
        } else if(enterprise.getEnterpriseType().getValue().equalsIgnoreCase("MedicalServices")){
            for (Organization.Type type : Organization.Type.values()){
                if (type.getValue().equals(Organization.Type.PhysicalExaminationCenter.getValue()) || type.getValue().equals(Organization.Type.MRIScanCenter.getValue())
                        || type.getValue().equals(Organization.Type.MentalHealthCenterOrganization.getValue())){
                    comboBoxOrgType.addItem(type);
                }
            }
        } else if(enterprise.getEnterpriseType().getValue().equalsIgnoreCase("Investigation")){
            for (Organization.Type type : Organization.Type.values()){
                if (type.getValue().equals(Organization.Type.LegalServices.getValue())){
                    comboBoxOrgType.addItem(type);
                }
            }
        }else if(enterprise.getEnterpriseType().getValue().equalsIgnoreCase("Rehabilitation")){
            for (Organization.Type type : Organization.Type.values()){
                if (type.getValue().equals(Organization.Type.RehabCenter.getValue())){
                    comboBoxOrgType.addItem(type);
                }
            }
        }else if(enterprise.getEnterpriseType().getValue().equalsIgnoreCase("Psychiatrist")){
            for (Organization.Type type : Organization.Type.values()){
                if (type.getValue().equals(Organization.Type.MentalHealthCenterOrganization.getValue())){
                    comboBoxOrgType.addItem(type);
                }
            }
        }
    ...
    private void initComponents() {
        ...
        jPanel1.setMinimumSize(new java.awt.Dimension(671, 229));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 80, 210, 130));
        ...
        btnAddOrg.setBackground(new java.awt.Color(255, 204, 204));
        ...
        btnDltOrg.setBackground(new java.awt.Color(255, 204, 204));
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 1, -1, 300));
