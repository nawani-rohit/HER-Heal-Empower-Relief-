...
public class CaseReporterViewStatusJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel2.setMinimumSize(new java.awt.Dimension(1200, 400));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(21, 0, 570, 156));

        lblCaseVolunteer.setBackground(new java.awt.Color(255, 255, 255));
        ...
        lblCaseVolunteer.setText("Case Supervisor");
        ...
        jPanel2.add(lblDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 230, -1, -1));

        lblReceiver.setFont(new java.awt.Font("Monaco", 1, 14)); // NOI18N
        lblReceiver.setForeground(new java.awt.Color(255, 204, 204));
        ...
        lblPsych.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel2.add(btnCheckStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 130, 150, -1));

        lblStatus.setFont(new java.awt.Font("Monaco", 1, 14)); // NOI18N
        lblStatus.setForeground(new java.awt.Color(255, 204, 204));
        lblStatus.setText("Status:");
        jPanel2.add(lblStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 320, -1, 21));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 980, 430));
            ...
            CaseReporterWorkRequest  CaseRepoWorkReq  = (CaseReporterWorkRequest) tableCases.getValueAt(selectedRow, 3);
                 if(CaseRepoWorkReq!=null){
                     ...
                     txtCaseVolunteerStatus.setText(CaseRepoWorkReq.getStatus());
                        ...
                        if(CaseRepoWorkReq.getCounselorWorkRequest()!=null){
                            CounselorWorkRequest C = CaseRepoWorkReq.getCounselorWorkRequest(); 
