...
import business.Role.MedicalServicesAdminRole;
import business.Role.LegalServicesAdminRole;
import business.Role.ASITAdminRole;
...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblManageEnterpriseAdmins.setForeground(new java.awt.Color(255, 204, 204));
        lblManageEnterpriseAdmins.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblManageEnterpriseAdmins.setText("Maintain Enterprise Administrators");
        add(lblManageEnterpriseAdmins, new org.netbeans.lib.awtextra.AbsoluteConstraints(58, 32, 687, 40));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 140, 490, 170));

        lblSelectEnterprise.setFont(new java.awt.Font("Monaco", 1, 14)); // NOI18N
        lblSelectEnterprise.setForeground(new java.awt.Color(255, 255, 255));
        lblSelectEnterprise.setText("Select Enterprise:");
        add(lblSelectEnterprise, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 174, -1, -1));

        lblNetwork.setFont(new java.awt.Font("Monaco", 1, 14)); // NOI18N
        lblNetwork.setForeground(new java.awt.Color(255, 255, 255));
        lblNetwork.setText("Select City:");
        ...
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(81, 212, 71, -1));
        add(txtNameOfAdmin, new org.netbeans.lib.awtextra.AbsoluteConstraints(158, 212, 130, -1));

        jLabel5.setFont(new java.awt.Font("Monaco", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Set Username:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 256, 110, 26));
        add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(158, 256, 130, -1));

        jLabel6.setFont(new java.awt.Font("Monaco", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Set Password:");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 307, 110, -1));
        ...
        add(btnSubmit, new org.netbeans.lib.awtextra.AbsoluteConstraints(416, 358, -1, -1));
        add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(158, 300, 130, -1));
        ...
        add(comboBoxSelectNetwork, new org.netbeans.lib.awtextra.AbsoluteConstraints(158, 126, 130, -1));

        comboBoxSelectEnterprise.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(comboBoxSelectEnterprise, new org.netbeans.lib.awtextra.AbsoluteConstraints(158, 170, 130, -1));
        ...
        add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(596, 358, -1, -1));
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if(enterprise.getEnterpriseType().getValue().equalsIgnoreCase("MedicalServices")){
            if(enterprise.getUserAccountDirectory().CheckIsValidInput(password)){
                UserAccount userAccount=enterprise.getUserAccountDirectory().createUserAccnt(username, password, employee, new MedicalServicesAdminRole());
            }
            else{
        ...
        } else if(enterprise.getEnterpriseType().getValue().equalsIgnoreCase("Investigation")){
            if(enterprise.getUserAccountDirectory().CheckIsValidInput(password)){
                UserAccount userAccount=enterprise.getUserAccountDirectory().createUserAccnt(username, password, employee, new LegalServicesAdminRole());
            }
            else{
                JOptionPane.showMessageDialog(null, "Password should have a minimum length of 8 and contain atleast 1 Uppercase, 1 Lowercase, 1 Special character and 1 Digit ");
                txtPassword.setText("");
        ...
        }else if(enterprise.getEnterpriseType().getValue().equalsIgnoreCase("ASIT")){
            if(enterprise.getUserAccountDirectory().CheckIsValidInput(password)){
                UserAccount userAccount=enterprise.getUserAccountDirectory().createUserAccnt(username, password, employee, new ASITAdminRole());
            }
            else{
                JOptionPane.showMessageDialog(null, "Password should have a minimum length of 8 and contain atleast 1 Uppercase, 1 Lowercase, 1 Special character and 1 Digit ");
                txtPassword.setText("");
