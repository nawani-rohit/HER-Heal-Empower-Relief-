...
public class CaseReportJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblDate.setBackground(new java.awt.Color(59, 63, 66));

        lblVictimName.setFont(new java.awt.Font("Monaco", 1, 14)); // NOI18N
        lblVictimName.setForeground(new java.awt.Color(255, 255, 255));
        lblVictimName.setText("Victim name : ");

        lblRelation.setFont(new java.awt.Font("Monaco", 1, 14)); // NOI18N
        lblRelation.setForeground(new java.awt.Color(255, 255, 255));
        ...
        lblMoreDetail.setForeground(new java.awt.Color(255, 255, 255));
        ...
        lblNameSuspect.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txtNameofSuspect.setEditable(false);
        ...
        txtMoreDetails.setEditable(false);

        txtLocation.setEditable(false);

        txtVolunteerName.setEditable(false);
        ...
        txtDateofIncident.setEditable(false);

        txtSuspect.setEditable(false);
        ...
        lblVictimInfo.setForeground(new java.awt.Color(255, 204, 204));
        ...
        btnReqLawyer.setBackground(new java.awt.Color(255, 204, 204));
        ...
        add(btnReqLawyer, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 150, 190, 38));

        btnReqCounsellar.setBackground(new java.awt.Color(255, 204, 204));
        ...
        add(btnReqCounsellar, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 390, 190, 41));

        btnReqDoc.setBackground(new java.awt.Color(255, 204, 204));
        ...
        add(btnReqDoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 230, 190, 41));

        btnReqPsych.setBackground(new java.awt.Color(255, 204, 204));
        ...
        add(btnReqPsych, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 310, 190, 38));
    ...
    private void btnReqLawyerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReqLawyerActionPerformed
        ...
        Enterprise e= network.getEnterpriseDirectory().searchEnterprisebyType(Enterprise.EnterpriseType.Investigation);
    ...
    private void btnReqCounsellarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReqCounsellarActionPerformed
        CounselorWorkRequest counsellarreq = new CounselorWorkRequest();
        ...
        if (org!=null){
            org.getWorkQueue().getCounselorworkRequestList().add(counsellarreq);
            //userAccount.getWorkQueue().CaseReporterWorkRequestList().add(request);
            userAccount.getWrkQue().getCounselorworkRequestList().add(counsellarreq);
        }
    ...
    private void btnReqDocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReqDocActionPerformed
        ...
        Organization org = null;
        for (Organization organization : e.getOrganizationDirectory().getOrganizationList()){
            if (organization instanceof PhysicalExaminationCenterOrganization){
                org = organization;
                break;
            }
        }
    ...
    private void btnReqPsychActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReqPsychActionPerformed
        ...
        Organization org = null;
        for (Organization organization : e.getOrganizationDirectory().getOrganizationList()){
            if (organization instanceof MentalHealthCenterOrganization){
                org = organization;
                break;
            }
        }
